...
class Box {
    ...
    getFile(uri) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield cross_fetch__WEBPACK_IMPORTED_MODULE_0___default()(uri);
            if (!response.ok) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "Box": () => (/* reexport safe */ _Box_node_js__WEBPACK_IMPORTED_MODULE_3__.Box),
...
/* harmony import */ var _Box_node_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./Box-node.js */ "./src/Box-node.ts");
...
console.log("Ciao ciao from esm1");
const p = new _Plant_js__WEBPACK_IMPORTED_MODULE_2__.Plant("orchidea");
const b = new _Box_node_js__WEBPACK_IMPORTED_MODULE_3__.Box("garden");
b.addObject(p);
